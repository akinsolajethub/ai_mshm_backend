...
urlpatterns = [
    ...
    path("fmc/walk-in/", GenericWalkInView.as_view(), {"facility": "fmc"}, name="fmc-walk-in"),
    path("sth/walk-in/", GenericWalkInView.as_view(), {"facility": "sth"}, name="sth-walk-in"),
    path("stth/walk-in/", GenericWalkInView.as_view(), {"facility": "stth"}, name="stth-walk-in"),
    path("fth/walk-in/", GenericWalkInView.as_view(), {"facility": "fth"}, name="fth-walk-in"),
    path("hmo/walk-in/", GenericWalkInView.as_view(), {"facility": "hmo"}, name="hmo-walk-in"),
    path("cln/walk-in/", GenericWalkInView.as_view(), {"facility": "cln"}, name="cln-walk-in"),
    path("pvt/walk-in/", GenericWalkInView.as_view(), {"facility": "pvt"}, name="pvt-walk-in"),
    path("ptth/walk-in/", GenericWalkInView.as_view(), {"facility": "ptth"}, name="ptth-walk-in"),
