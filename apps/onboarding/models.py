...
class OnboardingProfile(models.Model):
    ...
    ethnicity = models.CharField(max_length=30, choices=Ethnicity.choices, blank=True)
    ...
    cycle_regularity = models.CharField(max_length=15, choices=CycleRegularity.choices, blank=True)
    ...
    selected_wearable = models.CharField(max_length=20, choices=WearableDevice.choices, blank=True)
